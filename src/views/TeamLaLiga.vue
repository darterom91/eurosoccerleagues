        ...
        <div v-for="(tableTeamLaLiga, JYindex) in standingLaLiga.table" :key="JYindex">
          <div v-if="tableTeamLaLiga.team.id == id">
            <div class="text1 d-flex border border-dark bg-warning ">
              <div class="text-center border border-dark w-75 p-2">TEAM: {{tableTeamLaLiga.team.name}}</div>
              <div class="text-center border border-dark w-25 p-2">pos: {{tableTeamLaLiga.position}}</div>
            </div>
            <div class="text2 d-flex flex-column flex-md-row text-center text-justify justify-content-center bg-dark p-2">
              <div class="d-flex flex-column flex-md-row">
                <div class="d-flex flex-md-column border border-dark text-light p-2">
                  ...
                  <div class="w-100">{{tableTeamLaLiga.playedGames}}</div>
                </div>
                <div class="d-flex flex-md-column border border-dark text-light p-2">
                  <div class="w-100">Won</div>
                  <div class="w-100">{{tableTeamLaLiga.won}}</div>
                </div>
                <div class="d-flex flex-md-column border border-dark text-light p-2">
                  <div class="w-100">Draw</div>
                  <div class="w-100">{{tableTeamLaLiga.draw}}</div>
                </div>
                <div class="d-flex flex-md-column border border-dark text-light p-2">
                  <div class="w-100">Lost</div>
                  <div class="w-100">{{tableTeamLaLiga.lost}}</div>
                </div>
              </div>
              <div class="d-flex flex-column flex-md-row ">
                <div class="d-flex flex-md-column border border-dark text-light p-2">
                  <div class="w-100">Points</div>
                  <div class="w-100">{{tableTeamLaLiga.points}}</div>
                </div>
                <div class="d-flex flex-md-column border border-dark text-light p-2">
                  <div class="w-100">Goals For</div>
                  <div class="w-100">{{tableTeamLaLiga.goalsFor}}</div>
                </div>
                <div class="d-flex flex-md-column border border-dark text-light p-2">
                  <div class="w-100">Goals Against</div>
                  <div class="w-100">{{tableTeamLaLiga.goalsAgainst}}</div>
                </div>
                <div class="d-flex flex-md-column border border-dark text-light p-2">
                  <div class="w-100">Goal Difference</div>
                  <div class="w-100">{{tableTeamLaLiga.goalDifference}}</div>
                </div>
              </div>
            </div>
          </div>
