<template>
  <div class="contenido">
    <cpHeader/>
    <div v-for="(standingSA, Jindex) in standingsSA.standings" :key="Jindex">
      <div v-if="standingSA.type == 'TOTAL' ">
        <div v-for="(tableTeamSA, JYindex) in standingSA.table" :key="JYindex">
          <div v-if="tableTeamSA.team.id == id">
            <div class="text1 d-flex border border-dark bg-warning ">
              <div class="text-center border border-dark w-75 p-2">TEAM: {{tableTeamSA.team.name}}</div>
              <div class="text-center border border-dark w-25 p-2">pos: {{tableTeamSA.position}}</div>
            </div>
            <div class="text2 d-flex flex-column flex-md-row text-center text-justify justify-content-center bg-dark p-2">
              <div class="d-flex flex-column flex-md-row">
                <div class="d-flex flex-md-column border border-dark text-light p-2">
                  ...
                  <div class="w-100">{{tableTeamSA.playedGames}}</div>
                </div>
                <div class="d-flex flex-md-column border border-dark text-light p-2">
                  <div class="w-100">Won</div>
                  <div class="w-100">{{tableTeamSA.won}}</div>
                </div>
                <div class="d-flex flex-md-column border border-dark text-light p-2">
                  <div class="w-100">Draw</div>
                  <div class="w-100">{{tableTeamSA.draw}}</div>
                </div>
                <div class="d-flex flex-md-column border border-dark text-light p-2">
                  <div class="w-100">Lost</div>
                  <div class="w-100">{{tableTeamSA.lost}}</div>
                </div>
              </div>
              <div class="d-flex flex-column flex-md-row ">
                <div class="d-flex flex-md-column border border-dark text-light p-2">
                  <div class="w-100">Points</div>
                  <div class="w-100">{{tableTeamSA.points}}</div>
                </div>
                <div class="d-flex flex-md-column border border-dark text-light p-2">
                  <div class="w-100">Goals For</div>
                  <div class="w-100">{{tableTeamSA.goalsFor}}</div>
                </div>
                <div class="d-flex flex-md-column border border-dark text-light p-2">
                  <div class="w-100">Goals Against</div>
                  <div class="w-100">{{tableTeamSA.goalsAgainst}}</div>
                </div>
                <div class="d-flex flex-md-column border border-dark text-light p-2">
                  <div class="w-100">Goal Difference</div>
                  <div class="w-100">{{tableTeamSA.goalDifference}}</div>
                </div>
              </div>
            </div>
          </div>
    ...
    <div>
      <div>
        <div v-for="(tm, Xindex) in teamsSA.teams" :key="Xindex">
      ...
      <div class="bg-dark">
        <div v-for="(TMmatches, Yindex) in matchesSA.matches" :key="Yindex">
