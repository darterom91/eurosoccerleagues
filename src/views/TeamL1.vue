  ...
  <div class="contenido">
    ...
    <div v-for="(standingL1, Jindex) in standingsL1.standings" :key="Jindex">
      <div v-if="standingL1.type == 'TOTAL' ">
        <div v-for="(tableTeamL1, JYindex) in standingL1.table" :key="JYindex">
          <div v-if="tableTeamL1.team.id == id">
            <div class="text1 d-flex border border-dark bg-warning ">
              <div class="text-center border border-dark w-75 p-2">TEAM: {{tableTeamL1.team.name}}</div>
              <div class="text-center border border-dark w-25 p-2">pos: {{tableTeamL1.position}}</div>
            </div>
            <div class="text2 d-flex flex-column flex-md-row text-center text-justify justify-content-center bg-dark p-2">
              <div class="d-flex flex-column flex-md-row">
                <div class="d-flex flex-md-column border border-dark text-light p-2">
                  ...
                  <div class="w-100">{{tableTeamL1.playedGames}}</div>
                </div>
                <div class="d-flex flex-md-column border border-dark text-light p-2">
                  <div class="w-100">Won</div>
                  <div class="w-100">{{tableTeamL1.won}}</div>
                </div>
                <div class="d-flex flex-md-column border border-dark text-light p-2">
                  <div class="w-100">Draw</div>
                  <div class="w-100">{{tableTeamL1.draw}}</div>
                </div>
                <div class="d-flex flex-md-column border border-dark text-light p-2">
                  <div class="w-100">Lost</div>
                  <div class="w-100">{{tableTeamL1.lost}}</div>
                </div>
              </div>
              <div class="d-flex flex-column flex-md-row ">
                <div class="d-flex flex-md-column border border-dark text-light p-2">
                  <div class="w-100">Points</div>
                  <div class="w-100">{{tableTeamL1.points}}</div>
                </div>
                <div class="d-flex flex-md-column border border-dark text-light p-2">
                  <div class="w-100">Goals For</div>
                  <div class="w-100">{{tableTeamL1.goalsFor}}</div>
                </div>
                <div class="d-flex flex-md-column border border-dark text-light p-2">
                  <div class="w-100">Goals Against</div>
                  <div class="w-100">{{tableTeamL1.goalsAgainst}}</div>
                </div>
                <div class="d-flex flex-md-column border border-dark text-light p-2">
                  <div class="w-100">Goal Difference</div>
                  <div class="w-100">{{tableTeamL1.goalDifference}}</div>
                </div>
              </div>
            </div>
          </div>
